...
<div class="tpl-portlet-components">
                <div class="portlet-title">
                    <div class="caption font-green bold">
                        <span class="am-icon-plus"></span> 上传歌曲
                    </div>
                ...
                <div class="tpl-block ">
                    ...
                    <div class="am-g tpl-amazeui-form">
                        ...
                        <div class="am-u-sm-12 am-u-md-9">
                            <form class="am-form am-form-horizontal" action="<%=basePath %>article/article/save" method="POST">
                                <div class="am-form-group">
                                    <%--@declare id="user-name"--%><label for="user-name" class="am-u-sm-3 am-form-label">歌曲名称</label>
                                    <div class="am-u-sm-9">
                                 ...
                                 <div class="am-form-group">
                                    <label for="user-name" class="am-u-sm-3 am-form-label">源文件</label>
                                    <div class="am-u-sm-9">
                                        <input type="text" readonly id="filePath" name="filePath"  required placeholder="">
                                        <a href="javascript:;" class="uploadFile">点击上传</a>
                                        <small></small>
                                    </div>
                                </div>
                                
                                  <div class="am-form-group">
                                    <label for="user-name" class="am-u-sm-3 am-form-label">歌手/简介</label>
                                    <div class="am-u-sm-9">
 ...
 <div class="am-form-group">
                                    <label for="user-name" class="am-u-sm-3 am-form-label">歌词</label>
                                    <div class="am-u-sm-9">
...
window.onload = function(){
	...
	$(".uploadFile").click(function(){
		openWindow("${pageContext.request.contextPath}/upload2.jsp");
	});
